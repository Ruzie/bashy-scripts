...
if [[ ! $(whoami) == "root"* ]]; then
	...
	apt install neofetch git mpv libgconf-2-4 libc++1 micro wget xclip gimp zip unzip gzip hexchat htop ffmpeg nasm net-tools passwd apt-transport-https gpg -y
